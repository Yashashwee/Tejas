...
public class InstructionClassTable {
	...
	private static void createInstructionClassHandlerTable() {
		...
		instructionClassHandlerTable.put(InstructionClass.MFENCE,
		new Mfence());
		instructionClassHandlerTable.put(
			InstructionClass.CACHE_FLUSH,
			new CacheFlush());
		instructionClassHandlerTable.put(
			InstructionClass.SYS_CALL, 
			new SysCall());
		instructionClassHandlerTable.put(
	...
	private static void createInstructionClassTable() 
	{
		...
		instructionClassTable.put(cfluschImmediate, InstructionClass.CACHE_FLUSH);

		String syscall = "syscall";
		instructionClassTable.put(syscall, InstructionClass.SYS_CALL);

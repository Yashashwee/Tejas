...
public class LSQ extends SimulationElement
{
	 ...
	 */
	private enum LSQSearchStatus {Forwarded, CanBeForwarded, ShouldGoToL1, Stall};
	...
	protected LSQSearchStatus loadResolve(int index, LSQEntry entry)
	{
		...
		// if(config.SimulationConfig.memoryModel == memorysystem.MemoryModels.SC )
		// {
